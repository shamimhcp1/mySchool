 ...
 */
    ...
    $student = new Student();
    $queryResult = $student->editStudent($_GET['id']);
        ...
        <div class="card bg-success text-white">
            <form action="" method="post" class="">
                <div class="card-header">
                    <h2><strong>Edit</strong> Student Info</h2>
                </div>
                <div class="card-body card-block">
                    ...
                    <div class="form-group"><label class=" form-control-label">Mobile</label>
                        <input type="number" name="mobile" value="<?php echo $data['mobile']; ?>" class="form-control">
                    </div>
                </div>
                <div class="card-footer">
                    <button type="submit" name="btn" class="btn btn-danger btn-sm">
